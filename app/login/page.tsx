      ...
      <div className={styles.card}>
        ...
        <div className={styles.hero}>
          <div className={styles.logoWrap}>
              <img src="/MexiGoLogo.png" alt="MexiGo" style={{ height: "48px", objectFit: "contain", maxWidth: "160px" }} />
            </div>
            <div style={{ width: "80%", height: "1px", background: "rgba(0,0,0,0.1)", margin: "8px auto" }} />
            <div style={{ display: "flex", justifyContent: "center" }}>
              <img src="/CoppelLogo.png" alt="Coppel" style={{ height: "32px", objectFit: "contain", maxWidth: "120px" }} />
            </div>
        </div>
